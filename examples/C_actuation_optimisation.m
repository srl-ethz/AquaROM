% ------------------------------------------------------------------------ 
% C_actuation_optimisation.m
%
% Description: optimization of a simple actuation signal.
% 
...
% Optimisation
tStart = tic;
out = optimise_actuation(myElementConstructor,nsetBC, ...
