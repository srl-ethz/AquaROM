...
hf = PlotFieldonDeformedMeshCustom(nodes, elementPlot, v, 'factor', 1, 'lineWidth', lineWidthPatchForPlot);
hold off
...
v = reshape(U(:,7)*0.9, 3, []).';
PlotFieldonDeformedMeshCustom(nodes, elementPlot, v, 'factor', 1, 'lineWidth', lineWidthPatchForPlot);
