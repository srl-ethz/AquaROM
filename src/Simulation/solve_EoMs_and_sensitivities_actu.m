...
function TI_NL_PROM = solve_EoMs_and_sensitivities_actu(V,PROM_Assembly,fIntTensors,tailProperties,spineProperties,dragProperties,actuTop,actuBottom,kActu,h,tmax,pActu)
    ...
    Residual_sens = @(s,sd,sdd,t,etaSol,drdqdd, drdqd, drdq)residual_linear_sens_combined_actu(s,sd,sdd,t,etaSol,drdqdd,drdqd,drdq,pd_actu,pActu);                                                     
